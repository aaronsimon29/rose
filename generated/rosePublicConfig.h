...
#define ROSE_SCM_VERSION_ID "0.11.145.317"

/* Git SCM version information for ROSE: commit date (Unix timestamp). */
#define ROSE_VERSION 111450317

/* Define user-friendly ROSE version */
#define ROSE_PACKAGE_VERSION "0.11.145.317"
...
/* #undef ROSE_SUPPORT_MICROSOFT_EXTENSIONS */

/* Create the configuration synopsis token for use by Rose::initialize */
#define ROSE_CONFIG_TOKEN "rose-0.11.145.317 boost-1.81.0 pthread"
